...
class profile:
    ...
    def getSys(self):
        ...
        if result:
            ...
            return False
    def profileImport(self,name):
        jobid=self.lc.ImportSystemConfiguration(IPAddress='100.98.4.4',ShareName='public/test',ShareType='2',FileName=name)
